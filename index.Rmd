---
title: <p class="title">Introduction à R</p><hr class="lign"><p class="title2">Statistique descriptive univariée et bivariée</p>
author: Hugues Pecout (FR CIST, CNRS)  <br>  Timothée Giraud (UMS RIATE, CNRS)
date: Master G2M, 7-9 septembre 2020
css: style_new.css
output:
...
<p class="objectif1">Objectifs :  </p>

<p class="objectif2"> --  **Acquérir les bases du logiciel/language R et de son environnement RStudio** </p>
<p class="objectif2"> --  **Acquérir les bases de la statistique descriptive univariée et bivariée sur R**</p>
<p class="objectif2"> --  **Comprendre les atouts de R pour la gestion, l'analyse et la représentation de données**</p>
...
<p class="objectif3"><img src="figures/diapo.png" width="170"/></a></p>
<p class="objectif3">[Consulter le diaporama d'introduction](https://hpecout.gitpages.huma-num.fr/R_presentation_FR/#/){target="_blank"}</p>
